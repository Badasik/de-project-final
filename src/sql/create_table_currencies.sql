DROP TABLE IF EXISTS STV2023100639__STAGING.currencies CASCADE;
DROP PROJECTION IF EXISTS STV2023100639__STAGING.currencies_proj1 CASCADE;

CREATE TABLE STV2023100639__STAGING.currencies(
...
CREATE PROJECTION STV2023100639__STAGING.currencies_proj1(
 date_update,
 currency_code,
 currency_code_with,
 currency_with_div)
AS
 ...
 FROM STV2023100639__STAGING.currencies
